...
public class PlayerAttackEffects : MonoBehaviour
{
    ...
    public GameObject groudImpact_Spawn, kickFX_Spawn, fireTornado_Spawn, fireShield_Spawn;
    ...
    void GroundImpact()
    {
        Instantiate(groundImpact_Prefab, groudImpact_Spawn.transform.position, Quaternion.identity);
    }
    void Kick()
    {
    ...
    void Heal()
    {
        ...
        temp.y += 2f;
        GameObject healObj = Instantiate(healthFX_Prefab, temp, Quaternion.identity) as GameObject;
